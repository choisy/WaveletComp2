...
function(x, y, start = 1,
         ...
         n.sim = 100, save.sim = FALSE, log2scale = TRUE) {
  ...
  WC =  WaveletCoherency(x, y, dt = dt, dj = dj,
                         ...
                         window.type.t=window.type.t, window.type.s=window.type.s, window.size.t=window.size.t, window.size.s=window.size.s, log2scale = log2scale)
